...
const Navbar = ({ setShowLogin, setShowContact }) => {
  ...
  return (
    <div className="flex justify-center w-full h-20 bg-transparent fixed top-1 left-0 z-50">
      <div className='bg-white w-[80%] h-20 flex items-center justify-between p-8 shadow-sm rounded-2xl'>
