  ...
  return (
    <div className='bg-[#F3F0E9] w-full h-[700px] text-amber-950 rounded-2xl flex justify-around'>
      <div className="mt-[14%] ml-[7%]">
        ...
        <button className=' cursor-pointer rounded-[25px] border border-amber-950 bg-amber-950 outline-0 text-[#FFCC02] py-2 px-5 font-bold text-[20px] transition duration-500
